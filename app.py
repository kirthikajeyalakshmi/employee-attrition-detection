...
model = joblib.load(r"C:\Users\rdhan\Downloads\model.pkl")
features_list = joblib.load(r"C:\Users\rdhan\Downloads\features.pkl")  # Must match model
...
inputs = {
    ...
    'BusinessTravel': label_maps['BusinessTravel'][st.sidebar.selectbox("Business Travel", list(label_maps['BusinessTravel'].keys()))],
    ...
    'EnvironmentSatisfaction': satisfaction_levels[st.sidebar.selectbox("Environment Satisfaction", list(satisfaction_levels.keys()))],
    ...
    'MaritalStatus': label_maps['MaritalStatus'][st.sidebar.selectbox("Marital Status", list(label_maps['MaritalStatus'].keys()))],
    ...
    'RelationshipSatisfaction': satisfaction_levels[st.sidebar.selectbox("Relationship Satisfaction", list(satisfaction_levels.keys()))],
